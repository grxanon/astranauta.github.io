function parseschool (school) {
	...
	if (school === "VM") return "void magic";
	return "";
}
...
window.onload = function load() {
	...
	$("form#filtertools select").change(function(){
		...
		let thirdpartyfilter = $("select.pp3filter").val();
